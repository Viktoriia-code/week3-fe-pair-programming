      ...
      <div className="section-center featured-center">
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imgTours1} className="tour-img" alt="Tibet Adventure" />
        ...
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imgTours2} className="tour-img" alt="best of java" />
        ...
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imgTours3} className="tour-img" alt="explore hong kong" />
        ...
        <article className="tour-card">
          <div className="tour-img-container">
            <img src={imgTours4} className="tour-img" alt="kenya highlights" />
